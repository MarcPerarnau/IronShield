...
$stmt = $conexion->prepare("SELECT id, tipo, valor, rango, fecha, comentario FROM blacklist WHERE empresa_id = ?");
...
<main class="content">
            ...
            <tbody>
                <?php foreach ($entradas as $item): ?>
                    <tr>
                        ...
                        <td>
                            <a href="editar_blacklist.php?id=<?php echo $item['id']; ?>" title="Editar" class="accion-boton">📝</a>
                            <a href="eliminar_blacklist.php?id=<?php echo $item['id']; ?>" onclick="return confirm('¿Eliminar esta entrada de la blacklist?')" title="Eliminar" class="accion-boton">🗑️</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
    ...
    <div id="modal" class="modal oculto">
        <div class="modal-contenido">
            ...
            <form action="procesar_blacklist.php" method="POST">
